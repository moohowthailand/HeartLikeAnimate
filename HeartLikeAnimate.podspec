...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of HeartLikeAnimate.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/methawin/HeartLikeAnimate'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'methawin' => 'pai.pp@hotmail.co.th' }
  s.source           = { :git => 'https://github.com/methawin/HeartLikeAnimate.git', :tag => s.version.to_s }
